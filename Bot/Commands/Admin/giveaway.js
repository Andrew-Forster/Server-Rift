...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const giveawayDb = await giveaways.loadGiveaways();
        const id = giveawayDb.length + 1;
        console.log(id);
        giveaways.saveGiveaway(id, prize, endTime, winners, giveawayChannel.id, interaction.guild.id, message.id);
